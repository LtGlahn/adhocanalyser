...
def gdf2geojson( myGdf, objektTypeId=45, dakatVersjon=2.29, tag='bomstasjon',  comment='Bomstasjonsdata basert på regneark fra autopass-systemet'): 
    """
