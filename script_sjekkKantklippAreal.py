...
mittFilter = { 'kontraktsomrade' : '9303 Hardanger og Sogn 2022-2027' }
...
dagens = pd.DataFrame( nvdbapiv3.nvdbFagdata(301, filter=mittFilter ).to_records( vegsegmenter=False ) )
